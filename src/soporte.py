...
def px_demanda(año):
    ...
    """
    with open(f"data/px_demanda.pkl", "rb") as demanda:
...
def px_demanda_real(año, semana):
    ...
    """
    with open(f"data/px_demanda_real.pkl", "rb") as demanda_real:
...
def px_demanda_estacion():
    ...
    """
    with open(f"data/px_demanda_estacion.pkl", "rb") as demanda_estacion:
...
def px_precio_historico():
    ...
    """
    with open(f"data/px_precio_historico.pkl", "rb") as precios_historico:
...
def px_precio_diario(año):
    with open(f"data/px_precio_diario.pkl", "rb") as precio_diario:
...
def px_porcentage_renovables_barplot():
    ...
    """
    with open(f"data/px_porcentage_renovables.pkl", "rb") as porcentage_renovables:
...
def px_balance_renovables(energias):
    ...
    """
    with open(f"data/px_balance_renovables.pkl", "rb") as balance_renovables:
...
def px_evo_reno():
    ...
    """
    with open(f"data/px_evo_reno.pkl", "rb") as evo_reno:
...
def px_emisiones():
    ...
    """
    with open(f"data/px_emisiones.pkl", "rb") as emisiones:
...
def px_perdidas():
    ...
    """
    with open(f"data/px_perdidas.pkl", "rb") as perdidas:
...
def px_generado():
    ...
    """
    with open(f"data/px_generado.pkl", "rb") as generado:
...
def px_prediccion():
    ...
    """
    with open("data/px_prediccion.pkl", "rb") as prediccion_demanda:
